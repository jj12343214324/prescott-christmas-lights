    ...
    <section className="py-20 bg-gradient-to-b from-white to-green-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
                  ...
                  <div className="text-right">
                    ...
                    {reviews[currentIndex].reviewCount && (
                      <p className="text-xs text-gray-400 mt-1">
                        {reviews[currentIndex].reviewCount} reviews
                      </p>
                    )}
                  </div>
                </div>
          ...
          <button
            onClick={prevReview}
            className="absolute left-0 md:-left-16 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:bg-gray-50 transition-colors"
          >
          ...
          <button
            onClick={nextReview}
            className="absolute right-0 md:-right-16 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:bg-gray-50 transition-colors"
          >
